...
export async function addApiInfo(body: API.ApiInfoAddRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLong>(`/facade/add`, {
    method: 'POST',
    headers: {
...
export async function deleteApiInfo(body: API.DeleteRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`/facade/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getApiInfoById(
  ...
  return request<API.BaseResponseApiInfo>(`/facade/get`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function invokeApiInfo(
  ...
  return request<API.BaseResponseObject>(`/facade/invoke`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listApiInfoByPage(
  ...
  return request<API.BaseResponsePageApiInfo>(`/facade/list/page`, {
    method: 'GET',
    params: {
      ...params,
      apiInfoQueryRequest: undefined,
...
export async function offlineApiInfo(body: API.IdRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`/facade/offline`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function onlineApiInfo(body: API.IdRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`/facade/online`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateApiInfo(
  ...
  return request<API.BaseResponseBoolean>(`/facade/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
