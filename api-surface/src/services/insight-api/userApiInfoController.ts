...
export async function addUserApiInfo(
  ...
  return request<API.BaseResponseLong>('/userApiInfo/add', {
    method: 'POST',
    headers: {
...
export async function deleteUserApiInfo(body: API.DeleteRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/userApiInfo/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getUserApiInfoById(
  ...
  return request<API.BaseResponseUserApiInfo>('/userApiInfo/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function invokeCount(
  ...
  return request<API.BaseResponseBoolean>('/userApiInfo/invokeCount', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listUserApiInfo(
  ...
  return request<API.BaseResponseListUserApiInfo>('/userApiInfo/list', {
    method: 'GET',
    params: {
      ...params,
...
export async function listUserApiInfoByPage(
  ...
  return request<API.BaseResponsePageUserApiInfo>('/userApiInfo/list/page', {
    method: 'GET',
    params: {
      ...params,
      userApiInfoQueryRequest: undefined,
...
export async function updateUserApiInfo(
  ...
  return request<API.BaseResponseBoolean>('/userApiInfo/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
