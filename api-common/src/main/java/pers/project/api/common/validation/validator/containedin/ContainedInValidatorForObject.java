...
/**
 * {@link ContainedIn} 对象校验器
 * <p>
 * 被校验的 {@code Object} 可以为 {@code null}。
 * <p>
 * 如果不为 {@code null}，那么它必须包含在指定的 {@code Set} 中。
 * <p>
...
public class ContainedInValidatorForObject extends AbstractContainedInValidator<Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        boolean isValid = validSet.contains(value);
        if (!isValid) {
